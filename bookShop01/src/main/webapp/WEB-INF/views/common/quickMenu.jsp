...
<body>    
    <div id="sticky" >
	<ul>
		<li><a href="https://www.facebook.com/NetflixKR/">
		   <img	width="24" height="24" src="${contextPath}/resources/image/facebook_icon.png">
				페이스북
		</a></li>
		<li><a href="https://www.instagram.com/today_netflix/">
		   <img width="24" height="24" src="${contextPath}/resources/image/insta_icon.png">
			인별그램
		</a></li>
		<li><a href="#">
