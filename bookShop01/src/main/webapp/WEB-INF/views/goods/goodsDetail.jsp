...
function zzim(goods_id) {
	$.ajax({
		...
		error : function(data, textStatus) {
			alert("찜할 수 없습니다. 대신 바로 구매로 이동합니다."+data);
	...
	function add_cart(goods_id) {
		$.ajax({
			...
			error : function(data, textStatus) {
				alert("장바구니에 최대 2개까지 보관 가능합니다."+data);
			},
			complete : function(data, textStatus) {
				//alert("작업을완료 했습니다");
			}
...
<body>
	<hgroup>
		<h1>국내외 영화</h1>
		<h2>국내외 영화 &gt; 국내 &gt; 국내 코미디</h2>
		<h3>${goods.goods_title }</h3>
		<h4>감독 : ${goods.goods_writer} &nbsp; 배급사 | ${goods.goods_publisher}</h4>
	</hgroup>
	<div id="goods_image">
		<figure>
			<img alt="HTML5 &amp; CSS3"
	...
	<div id="detail_table">
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="active">${goods.goods_point}P(1%적립)</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed">포인트 추가적립</td>
					<td class="fixed">만원이상 구매시 1,000P, 5만원이상 구매시 2,000P추가적립 </td>
				</tr>
				<tr>
				...
				<tr>
					<td class="fixed">상영시간</td>
					<td class="fixed">${goods.goods_total_page}분</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed">평점</td>
		...
		<ul>
			...
			<li><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');">비디오 구독하기</a></li>
			<li><a class="cart" href="javascript:add_cart('${goods.goods_id }')">장바구니  담기</a></li>
			<li><a class="cart" href="javascript:zzim('${goods.goods_id }')">찜하기</a></li>
	...
	<div id="container">
		<ul class="tabs">
			...
			<li><a href="#tab3">배우/제작진</a></li>
			<li><a href="#tab4">영화후기</a></li>
			<li><a href="#tab5">감독한마디</a></li>
			<li><a href="#tab6">명대사</a></li>
		</ul>
		<div class="tab_container">
			...
			<div class="tab_content" id="tab6">
				<h4>명대사</h4> <!--GOODS_CREDATE  -->
				<%-- <p>${fn:replace(goods.goods_goods_credate,crcn,br)}</p> --%>
				<p>${fn:replace(goods.goods_delivery_price,crcn,br)}</p>
				<%-- <p>${fn:replace(goods.goods_publisher_comment ,crcn,br)}</p> --%>
			</div>
		</div>
	</div>
